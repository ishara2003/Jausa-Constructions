...
public class AdminProjectOwnerController {
    public Label lblDeletePanter;
    public AnchorPane AdminProjectOwnerForm;
...
//            try {
//                boolean isDeleted=P_OwnerModel.deleteP_Owner(DeleteNic.getText());
//                if(isDeleted){
//                    JOptionPane.showMessageDialog(null,"Deleted Successfuly");
//                    loadAllCustomers();
//                }
...
//=======================================Tables Right click Slider Ends=================================================
    ...
    @FXML
    void backToDetailsOnAction(MouseEvent event) {

    }
    @FXML
    void backToIncomeOnAction(MouseEvent event) throws IOException {
        Navigation.navigate(Routes.ADMIN_INCOME_FROM,AdminProjectOwnerForm);

    }
    @FXML
    void backToManagerForm(MouseEvent event) throws IOException {
        Navigation.navigate(Routes.ADMIN_FROM,AdminProjectOwnerForm);
    }
    @FXML
    ...
    void backToProjectsOnAction(MouseEvent event) throws IOException {
        Navigation.navigate(Routes.ADMIN_PROJECT_MANAGE,AdminProjectOwnerForm);
    }
    @FXML
    ...
    public void baackToOrderManage(MouseEvent mouseEvent) throws IOException {
        Navigation.navigate(Routes.ORDERS_MANAGE,AdminProjectOwnerForm);
    }
